...
Today it reads <N> of 95 open bounties with a real deadline, and 6 that are past theirs but still open.

It is called poidhz. MIT, stdlib python, fork it. If you issue bounties: write the date and a timezone in the description. It is the only place anyone can read it.

github.com/bettercallzaal/zpoidh
```
