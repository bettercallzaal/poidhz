# R4 closeout cast - draft

Post to /zabal, tag @bettercallzaal. Not sent - review first. Post AFTER the
Empire Builder CSV leaderboard is actually live, so this is true when posted.

---

quick update on the zabal gamez july open pot (poidh bounty 1249) -

i went to close this out and accidentally canceled the bounty instead of
withdrawing it to submit the split claim. my bad - full transparency on
that. the escrowed eth is back in treasury, not part of this.
