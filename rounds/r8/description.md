# R8 description (paste-ready for POIDH Title + Description)
...
**Title field:** `Best summary of poidhz - what it does and what is different`
...
Explain poidhz better than we can. Best summary wins the pot, and the pot grows as others chip in.

Go through the site, work out what it actually does, and tell people - the features, what is different about it, why anyone should care. Post it publicly. We will run the best one as the launch.
...
What to cover is up to you, but the ones that land usually hit these: every open poidh bounty with a stated deadline on one calendar, countdowns and a subscribable .ics feed, the submitter leaderboard, and /lost - the bounties on poidh's old contracts that the main site cannot show you at all. Poke at it and tell us what stands out. If something is broken or confusing, say that too; we would rather hear it in public than not hear it.
...
Clarity
+ Someone who has never heard of poidh understands what poidhz does in 10 seconds
+ It covers what is actually different, not just that it exists
+ It names who it is for instead of talking to everyone at once
+ It is accurate. A confident wrong detail is worse than a missing one
...
Submissions close 11:59pm PT, Sunday October 4, 2026.
Winner decided by contributor vote and announced by end of day Tuesday October 6, 2026.
