...
2. **The judging page.** `zpoidh.vercel.app/round/<N>/judging` only resolves if a judging
...
[OPTIONAL - verify first] - Page: https://zpoidh.vercel.app/round/<N>/judging
...
clip: <X-URL>
[OPTIONAL - verify first] breakdown: https://zpoidh.vercel.app/round/<N>/judging
```
